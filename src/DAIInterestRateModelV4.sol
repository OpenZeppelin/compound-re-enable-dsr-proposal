...
contract DAIInterestRateModelV4 is JumpRateModelV3 {
     ...
     */
    constructor(uint jumpMultiplierPerYear, uint kink_, address pot_, address jug_, address owner_) JumpRateModelV3(0, 0, jumpMultiplierPerYear, kink_, owner_) public {
